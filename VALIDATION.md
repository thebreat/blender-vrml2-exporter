...
The source archive includes a Blender-free smoke test for package imports and the VRML writer's point-color, corner-color, single- and multiple-material color, UV, texture-path, index-output, linked-group separation, unused-DEF cleanup, DEF/USE geometry reuse, shade-smoothing angle conversion, smoothing-aware geometry separation, safe geometry/UV rounding, UV deduplication, compact output, and WRZ compression branches.
